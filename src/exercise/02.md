...
I still need to select the root element with the id root,
I used React.createElement('div', {className: 'class', children: 'Hello world'})
but what is the React.createElement('span', null, 'hello')
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=mtran1712%40gmail.com).
